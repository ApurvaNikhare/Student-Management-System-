...
#====================================== search by roll no.===========================================
        ...
        btn_clear=Button(self.root,text="Clear", font= ("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=850,y=100,width=120,height=35)
...
#=========================== labels =========================================================================
        ...
        lbl_marks_ob=Label(self.root,text="Marks Obtain",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=150,height=50)
        ...
        lbl_per=Label(self.root,text="Percentag",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=900,y=230,width=150,height=50)
